...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    return zooAnimals.filter( x => { return x.population < 5 } );
  }
  console.log ('============ END OF 2.3 ==========')
  ...
  */
  ...
  function USApop(zooAnimals){
    return zooAnimals.reduce( (acc, item) => { return acc + item.population }, 0);
  }
  console.log ('============ END OF 2.4 ==========')
...
/* 🐴🐴🐴 Step 2: Volume Method 🐴🐴🐴
  ...
  // console.log ('3.2 - VOLUME: ', test.volume());
  console.log ('============ END OF 3.2 ==========')
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
  ...
  let testObj = {length: 4, width: 5, height: 5};
  const cuboid = new CuboidMaker(testObj);
  console.log ('CUBOID: ', cuboid);
  console.log ('============ END OF 3.4 ==========')
...
//🦄🦄🦄 1. Take your prototypes from above and refactor into class syntax. Please rename your class CuboidMakerTwo and your object cuboidTwo 🦄🦄🦄
  ...
  let testObj2 = {length: 4, width: 5, height: 5};
  const cuboidTwo = new CuboidMaker(testObj2);
  console.log ('CUBOID_TWO: ', cuboidTwo);
 

//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
  console.log(cuboidTwo.volume()); // 100
  console.log(cuboidTwo.surfaceArea()); // 130
  console.log ('============ END OF 4.1 ==========')
